...
class Attr {
  ...
  static const relacaoComCaminhoes = 'relacaoComCaminhoes';
  static const gostaDeSpringBoot = 'gostaDeSpringBoot';
  static const careca = 'careca';
  static const produzCerveja = 'produzCerveja';
  static const hobbyComAgua = 'hobbyComAgua';
  static const jogaBasquete = 'jogaBasquete';
  static const gostaDePedalar = 'gostaDePedalar';
  static const aulaEmCascavel = 'aulaEmCascavel';
  static const pareceGeladeiraDuasPortas = 'pareceGeladeiraDuasPortas';
  static const temCachorro = 'temCachorro';
  static const temPiercing = 'temPiercing';
}
...
const List<Question> questions = [
  ...
  Question(
    id: 22,
    text: 'O seu professor tem alguma relação com caminhões?',
    attributeId: Attr.relacaoComCaminhoes,
  ),
  Question(
    id: 23,
    text: 'O seu professor gosta muito de Spring Boot?',
    attributeId: Attr.gostaDeSpringBoot,
  ),
  Question(id: 24, text: 'O seu professor é careca?', attributeId: Attr.careca),
  Question(
    id: 25,
    text: 'O seu professor produz cerveja?',
    attributeId: Attr.produzCerveja,
  ),
  Question(
    id: 26,
    text: 'O seu professor tem um hobby relacionado com água?',
    attributeId: Attr.hobbyComAgua,
  ),
  Question(
    id: 27,
    text: 'O seu professor joga/jogou basquete?',
    attributeId: Attr.jogaBasquete,
  ),
  Question(
    id: 28,
    text: 'O seu professor gosta de pedalar?',
    attributeId: Attr.gostaDePedalar,
  ),
  Question(
    id: 29,
    text: 'O seu professor já deu aula em Cascavel?',
    attributeId: Attr.aulaEmCascavel,
  ),
  Question(
    id: 30,
    text: 'O seu professor é conhecido por parecer uma geladeira duas portas?',
    attributeId: Attr.pareceGeladeiraDuasPortas,
  ),
  Question(
    id: 31,
    text: 'O seu professor tem cachorro?',
    attributeId: Attr.temCachorro,
  ),
  Question(
    id: 32,
    text: 'O seu professor tem algum piercing?',
    attributeId: Attr.temPiercing,
  ),
];
...
const List<Professor> professors = [
  Professor(
    ...
    attributes: {
      ...
      Attr.relacaoComCaminhoes: 0.0,
      Attr.gostaDeSpringBoot: 0.0,
      Attr.careca: 0.0,
      Attr.produzCerveja: 0.0,
      Attr.hobbyComAgua: 0.0,
      Attr.jogaBasquete: 0.0,
      Attr.gostaDePedalar: 1.0,
      Attr.aulaEmCascavel: 1.0,
      Attr.pareceGeladeiraDuasPortas: 0.0,
      Attr.temCachorro: 1.0,
      Attr.temPiercing: 0.0,
    },
  ),
  Professor(
    ...
    attributes: {
      ...
      Attr.nomeComecaComVogal: 0.0,
      Attr.relacaoComCaminhoes: 1.0,
      Attr.gostaDeSpringBoot: 0.0,
      Attr.careca: 0.0,
      Attr.produzCerveja: 0.0,
      Attr.hobbyComAgua: 0.0,
      Attr.jogaBasquete: 1.0,
      Attr.gostaDePedalar: 0.0,
      Attr.aulaEmCascavel: 0.0,
      Attr.pareceGeladeiraDuasPortas: 0.0,
      Attr.temCachorro: 0.3,
      Attr.temPiercing: 1.0,
    },
  ),
  Professor(
    name: 'Jhoni',
  ...
  Professor(
    ...
    attributes: {
      ...
      Attr.gostaDeSpringBoot: 0.0,
      Attr.careca: 1.0,
      Attr.produzCerveja: 1.0,
      Attr.hobbyComAgua: 0.0,
      Attr.jogaBasquete: 0.0,
      Attr.gostaDePedalar: 0.0,
      Attr.aulaEmCascavel: 0.7,
      Attr.pareceGeladeiraDuasPortas: 0.0,
      Attr.temCachorro: 0.3,
      Attr.temPiercing: 0.0,
    },
  ...
  Professor(
    ...
    attributes: {
      ...
      Attr.hobbyComAgua: 0.0,
      Attr.jogaBasquete: 0.0,
      Attr.gostaDePedalar: 0.3,
      Attr.aulaEmCascavel: 0.0,
      Attr.pareceGeladeiraDuasPortas: 1.0,
      Attr.temCachorro: 0.3,
      Attr.temPiercing: 0.0,
    },
  ),
